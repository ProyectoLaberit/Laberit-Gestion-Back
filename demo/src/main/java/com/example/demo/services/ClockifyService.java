...
public class ClockifyService {
    ...
    List<ClockifyTareaDTO> resultado = new ArrayList<>();
    ...
    for (Map<String, Object> entry : body) {
        ...
        if (subfase == null || !subfase.equalsIgnoreCase(subfaseBuscada)) continue;
        ...
        // 🔹 Crear DTO
        ClockifyTareaDTO dto = new ClockifyTareaDTO(titulo, horas, idGit);
