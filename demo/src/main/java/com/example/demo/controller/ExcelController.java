...
public class ExcelController {
    ...
    /**
     * Genera un archivo Excel completo basado en la plantilla, inyectando los datos
     * de la BD.
     * 
    ...
    public ResponseEntity<byte[]> exportarExcel(@PathVariable Integer idExcel) {
        try {
            ...
            headers.add(HttpHeaders.CONTENT_DISPOSITION,
                    "attachment; filename=\"Estimacion_Proyecto_" + idExcel + ".xlsx\"");
    ...
    /**
     * Genera el Reporte Analítico inteligente cruzando datos de estimaciones,
     * GitLab y Clockify.
     * 
    ...
    public ResponseEntity<byte[]> exportarExcelAnalitico(@PathVariable Long idProyecto, @PathVariable Integer idExcel) {
        try {
            ...
            HttpHeaders headers = new HttpHeaders();
            headers.add(HttpHeaders.CONTENT_DISPOSITION,
                    "attachment; filename=\"Reporte_Analitico_Proyecto_" + idProyecto + ".xlsx\"");
            headers.add(HttpHeaders.CONTENT_TYPE, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
